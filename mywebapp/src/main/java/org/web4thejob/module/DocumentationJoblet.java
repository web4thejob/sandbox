...
@Component
public class DocumentationJoblet extends AbstractJoblet {
    ...
    public List<Resource> getResources() {
        ...
        try {
            for (Resource resource : resolver.getResources("classpath*:org/web4thejob/sandbox/orm/**/*.hbm.xml")) {
    ...
    public String getBasePackage() {
        return "org.web4thejob.sandbox.orm";
    }
